...
TODO: Wstawić screena i napisać co trzeba klikać (Może to wywalić? - Nie rozumiem tego pytania (Olek))
...
\begin{figure}[!]
  ...
  \label{fig:mojeweb}
\end{figure}
Na ekranie \ref{fig:mojeweb} widać spotkania, które student złożył prośby o zapisanie. Można sprawdzić, czy prośba została zaakceptowana.
