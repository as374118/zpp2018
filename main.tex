...
~~~~~Aby zaimplementować nasze formularze, stworzono trzy główne klasy oraz trzy dodatkowe:
...
Do tworzenia nowych kalendarzy, spotkań, uczestników, notatek służą przyciski \enquote{+Dodaj} w lewych górnych rogach odpowiednich formularzy.
...
Aby stworzyć nową notatkę należy kliknąć przycisk \enquote{+Dodaj}, znajduje się on po lewej stronie między formularzem, na którym wybiera się studenta, a formularzem z notatkami. 
...
Po wciśnięciu przycisku \enquote{Dodaj} lub przycisku przy uzasadnieniu do modyfikowania pojawi się formularz widoczny na ekranie \ref{fig:formularz_uzasadnienia}. Ten formularz służy do dodawania lub modyfikowania uzasadnień.
...
~~~~~Każdy parametr będący częścią zapytania do bazy przechodzi przez procedurę czyszczenia potencjalnie niebezpiecznych symboli oraz przy każdym zapytaniu do bazy danych traktuje się wyłącznie jako tekst (nie jako część polecenia). Robi się to w celu zapobiegania atakom typu SQL-injection.
